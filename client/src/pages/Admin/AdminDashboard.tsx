...
export default function AdminDashboard() {
                                ...
                                >
                                    <div className="p-5 flex-grow">
                                        <div className="flex justify-between items-start mb-2">
                                            ...
                                            <span
                                                className={`px-2 py-0.5 text-xs font-semibold rounded-full ${grant.status === "Active"
                                    ...
                                    {(inquiryStatusFilter === "all"
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4 max-w-xs">
                                                <div className="line-clamp-3 text-gray-700 text-xs whitespace-pre-wrap">{inquiry.specificNeeds || inquiry.message || ""}</div>
                                            </td>
                                            <td className="px-6 py-4">
                                                <span
    ...
    return (
        <div className="min-h-screen flex bg-gray-50">
            <aside
                className={`fixed md:relative w-64 bg-white shadow-md border-r flex flex-col justify-between h-full z-50 transition-transform duration-300 ease-in-out ${sidebarOpen ? "translate-x-0" : "-translate-x-full md:translate-x-0"
                    }`}
            >
                <div>
                    ...
                    <nav className="flex flex-col gap-1 mt-6 px-4 text-sm text-gray-700">
                        {sidebarItems.map((item) => (
                            <div
                                key={item.name}
                                className={`px-3 py-2.5 rounded-md cursor-pointer transition-all flex items-center ${activeTab === item.name
            ...
            <Dialog open={!!replyInquiry} onOpenChange={() => setReplyInquiry(null)}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Your response will be visible to the user in their dashboard.
                        </DialogDescription>
                    </DialogHeader>
                    <div className="py-4">
                        <Textarea
