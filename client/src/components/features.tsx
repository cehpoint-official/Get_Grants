  ...
  const features = [
    {
      ...
      color: "bg-white hover:bg-violet/20 border-2 border-violet",
      iconColor: "text-pink",
    },
    {
      icon: Filter,
    ...
    },
    {
      ...
      color: "bg-yellowish-white hover:bg-violet/20 border-2 border-violet hovet:border-pink ",
      iconColor: "text-pink",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg border-2 border-violet  ">
