  ...
  return (
    <section className="py-20" style={{ background:'white' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header Section - Updated for mobile */}
        <div className="text-center lg:text-left grid lg:grid-cols-12 gap-x-8 gap-y-6 items-center mb-16">
          ...
          <div className="lg:col-span-6">
            <p className="text-[#565F6C] text-lg leading-relaxed lg:pl-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-4 gap-6 md:gap-8">
          {tools.map((tool) => (
            <div
              key={tool.title}
              className="bg-white p-6 rounded-lg shadow-lg" // Added rounded-lg and shadow-lg
            >
