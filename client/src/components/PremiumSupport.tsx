    ...
    <div id="premium-support" className="bg-white">
      ...
      <section style={{
        ...
        <div className="container mx-auto px-4 py-16 md:py-24 text-center">
          ...
          <p className="mt-4 text-lg max-w-2xl mx-auto text-yellowish-white drop-shadow-md">
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8">
            {services.map((service) => (
              <div key={service.name} className="bg-yellowish-white p-8 rounded-2xl text-center shadow-xl border-2 border-pink hover:border-violet transition-all duration-300">
      ...
      <section id="how-it-works" className="py-20" style={{
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-pink rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
                <span className="text-2xl font-bold text-white">2</span>
              </div>
              <h3 className="text-xl font-semibold text-pink mb-4">Receive updates</h3>
              <p className="text-gray-700">
            ...
            <div className="text-center">
              <div className="w-16 h-16 bg-red rounded-full flex items-center justify-center mx-auto mb-6 shadow-lg">
                <span className="text-2xl font-bold text-white">3</span>
              </div>
              <h3 className="text-xl font-semibold text-red mb-4">Apply for grants</h3>
              <p className="text-gray-700">
      ...
      {/* Pricing Section */}
      <section id="pricing" className="py-20 bg-yellowish-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-violet mb-6">
              Choose Your Plan
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {/* Free Plan */}
            <div className="bg-white border-2 border-rose-gold rounded-2xl p-8 text-center hover:border-violet transition-all duration-300 hover:shadow-xl shadow-lg">
              <div className="mb-6">
                <h3 className="text-2xl font-bold text-rose-gold mb-2 ">Free</h3>
                <p className="text-gray-600">Perfect for getting started</p>
              </div>
              <div className="mb-8">
                <span className="text-4xl font-bold text-rose-gold">₹0</span>
              ...
              <Button onClick={() => setIsSignupModalOpen(true)} className="w-full bg-rose-gold hover:bg-pink text-white rounded-xl shadow-lg font-semibold">Get Started Free</Button>
            </div>

            {/* Pro Plan */}
            <div className="bg-white border-2 border-violet rounded-2xl p-8 text-center shadow-xl relative">
            ...
            {/* Enterprise Plan */}
            <div className="bg-white border-2 border-pink rounded-2xl p-8 text-center hover:border-violet transition-all duration-300 hover:shadow-xl shadow-lg">
              <div className="mb-6"><h3 className="text-2xl font-bold text-pink mb-2">Enterprise</h3><p className="text-gray-600">For teams & incubators</p></div>
              <div className="mb-8"><span className="text-4xl font-bold text-pink">₹2,999</span><span className="text-gray-600">/month</span></div>
              <ul className="text-left space-y-4 mb-8">
              ...
              <Button onClick={() => setIsContactModalOpen(true)} className="w-full bg-pink hover:bg-red text-white rounded-xl shadow-lg font-semibold">Contact Sales</Button>
            </div>
          </div>
        </div>
      </section>
